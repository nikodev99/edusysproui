import {z} from "zod";
import {academicYearSchemaMerge, classeSchemaMerge, individualSchemaMerge, studentSchemaMerge} from "@/schema";
...
export const reprimandSchema = z.object({
    ...
    type: z.string({required_error: "Le type de réprimande est réquis"}),
